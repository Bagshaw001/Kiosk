...
class Statistics extends Webpage{
  Statistics() : super(large:_StatisticsLarge());
...
class _StatisticsLarge extends StatefulWidget {
  const _StatisticsLarge({Key? key}) : super(key: key);

  @override
  __StatisticsLargeState createState() => __StatisticsLargeState();
}

class __StatisticsLargeState extends State<_StatisticsLarge> {
  @override
